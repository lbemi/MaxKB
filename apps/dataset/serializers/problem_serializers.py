...
class ProblemInstanceSerializer(ApiMixin, serializers.Serializer):
    ...
    content = serializers.CharField(
        required=True, max_length=256, error_messages=ErrMessage.char("问题内容")
    )
...
class ProblemSerializers(ApiMixin, serializers.Serializer):
    class Create(serializers.Serializer):
        ...
        problem_list = serializers.ListField(
            required=True,
            error_messages=ErrMessage.list("问题列表"),
            child=serializers.CharField(
                required=True, error_messages=ErrMessage.char("问题")
            ),
        )
    ...
    class Query(serializers.Serializer):
        ...
        content = serializers.CharField(
            required=False, error_messages=ErrMessage.char("问题")
        )
