...
class Problem(APIView):
    ...
    def post(self, request: Request, dataset_id: str):
        return result.success(
            ProblemSerializers.Create(
                data={"dataset_id": dataset_id, "problem_list": request.data}
            ).batch()
        )
    ...
    class Paragraph(APIView):
        ...
        @swagger_auto_schema(
            ...
            responses=result.get_api_array_response(
                ProblemApi.Paragraph.get_response_body_api()
            ),
            tags=["知识库/文档/段落/问题"],
        )
        @has_permissions(
    ...
    class OperateBatch(APIView):
        ...
        @swagger_auto_schema(
            ...
            operation_id="批量删除问题",
            request_body=ProblemApi.BatchOperate.get_request_body_api(),
        ...
        def delete(self, request: Request, dataset_id: str):
            return result.success(
                ProblemSerializers.BatchOperate(data={"dataset_id": dataset_id}).delete(
                    request.data
                )
            )
