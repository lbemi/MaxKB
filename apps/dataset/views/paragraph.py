...
class Paragraph(APIView):
    ...
    class Problem(APIView):
        ...
        def post(
            self, request: Request, dataset_id: str, document_id: str, paragraph_id: str
        ):
            return result.success(
            ...
            return result.success(
                ParagraphSerializers.Migrate(
                    data={
                        ...
                        "paragraph_id_list": request.data,
                    }
                ).migrate()
            )
