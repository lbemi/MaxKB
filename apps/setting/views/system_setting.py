...
class SystemSetting(APIView):
    class Email(APIView):
        ...
        def get(self, request: Request):
            return result.success(SystemSettingSerializer.EmailSerializer.one())
