...
from setting.models_provider.impl.zhipu_model_provider.credential.llm import (
...
model_info_list = [
    ...
    ModelInfo(
        "glm-3-turbo", "", ModelTypeConst.LLM, qwen_model_credential, ZhipuChatModel
    ),
]
model_info_manage = (
    ...
    .append_default_model_info(
        ModelInfo(
            "glm-4", "", ModelTypeConst.LLM, qwen_model_credential, ZhipuChatModel
        )
    )
    .build()
)
