...
from setting.models_provider.impl.gemini_model_provider.credential.llm import (
...
gemini_1_pro = ModelInfo(
    "gemini-1.0-pro",
    "最新的Gemini 1.0 Pro模型，随Google更新而更新",
    ModelTypeConst.LLM,
    gemini_llm_model_credential,
    GeminiChatModel,
)

gemini_1_pro_vision = ModelInfo(
    "gemini-1.0-pro-vision",
    "最新的Gemini 1.0 Pro Vision模型，随Google更新而更新",
    ModelTypeConst.LLM,
    gemini_llm_model_credential,
    GeminiChatModel,
)
...
model_info_manage = (
    ...
    .append_model_info(gemini_1_pro)
    .append_model_info(gemini_1_pro_vision)
    .append_default_model_info(gemini_1_pro)
    .build()
)
