...
from setting.models_provider.impl.xinference_model_provider.credential.llm import (
    XinferenceLLMModelCredential,
)
from setting.models_provider.impl.xinference_model_provider.model.embedding import (
    XinferenceEmbedding,
)
from setting.models_provider.impl.xinference_model_provider.model.llm import (
    XinferenceChatModel,
)
