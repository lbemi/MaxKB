...
from setting.models_provider.impl.xf_model_provider.credential.llm import (
...
model_info_list = [
    ModelInfo(
        "generalv3.5", "", ModelTypeConst.LLM, qwen_model_credential, XFChatSparkLLM
    ),
    ModelInfo(
        "generalv3", "", ModelTypeConst.LLM, qwen_model_credential, XFChatSparkLLM
    ),
    ModelInfo(
        "generalv2", "", ModelTypeConst.LLM, qwen_model_credential, XFChatSparkLLM
    ),
]
