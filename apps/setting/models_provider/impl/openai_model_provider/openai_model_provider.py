...
from setting.models_provider.impl.openai_model_provider.credential.embedding import (
    OpenAIEmbeddingCredential,
)
from setting.models_provider.impl.openai_model_provider.credential.llm import (
    OpenAILLMModelCredential,
)
from setting.models_provider.impl.openai_model_provider.model.embedding import (
...
model_info_list = [
    ...
    ModelInfo(
        "gpt-4o",
        "最新的GPT-4o，比gpt-4-turbo更便宜、更快，随OpenAI调整而更新",
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ...
    ModelInfo(
        "gpt-4-turbo-preview",
        "最新的gpt-4-turbo-preview，随OpenAI调整而更新",
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ModelInfo(
        "gpt-3.5-turbo-0125",
        "2024年1月25日的gpt-3.5-turbo快照，支持上下文长度16,385 tokens",
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ModelInfo(
        "gpt-3.5-turbo-1106",
        "2023年11月6日的gpt-3.5-turbo快照，支持上下文长度16,385 tokens",
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ...
    ModelInfo(
        "gpt-4-0125-preview",
        "2024年1月25日的gpt-4-turbo快照，支持上下文长度128,000 tokens",
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
    ModelInfo(
        "gpt-4-1106-preview",
        "2023年11月6日的gpt-4-turbo快照，支持上下文长度128,000 tokens",
        ModelTypeConst.LLM,
        openai_llm_model_credential,
        OpenAIChatModel,
    ),
