...
def insert_default_data(apps, schema_editor):
    ...
    TeamModel.objects.create(
        user_id="f0dd8f71-e4ee-11ee-8c84-a8a1595801ab", name="admin的团队"
    )
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auth_target_type",
                    models.CharField(
                        choices=[("DATASET", "数据集"), ("APPLICATION", "应用")],
                        default="DATASET",
                        max_length=128,
                        verbose_name="授权目标",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model_type",
                    models.CharField(max_length=128, verbose_name="模型类型"),
                ),
                (
                    "model_name",
                ...
                (
                    "credential",
                    models.CharField(max_length=5120, verbose_name="模型认证信息"),
                ),
                (
                    "user",
                    models.ForeignKey(
