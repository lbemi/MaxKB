...
class ModelEditApi(ApiMixin):
    ...
    def get_request_body_api():
        return openapi.Schema(
            ...
            properties={
                "name": openapi.Schema(
                    type=openapi.TYPE_STRING, title="模型名称", description="模型名称"
                ),
                "model_type": openapi.Schema(
                    type=openapi.TYPE_STRING, title="供应商", description="供应商"
                ),
        ...
        return openapi.Schema(
            ...
            properties={
                ...
                "permission_type": openapi.Schema(
                    type=openapi.TYPE_STRING, title="权限", description="PUBLIC|PRIVATE"
                ),
                "model_type": openapi.Schema(
                    type=openapi.TYPE_STRING, title="供应商", description="供应商"
                ),
