...
class ErrMessage:
    ...
    def char(field: str):
        return {
            ...
            "max_length": gettext_lazy(
                "【%s】请确保此字段的字符数不超过 {max_length} 个。" % field
            ),
            "min_length": gettext_lazy(
                "【%s】请确保此字段至少包含 {min_length} 个字符。" % field
            ),
    ...
    def integer(field: str):
        return {
            "invalid": gettext_lazy("【%s】必须是有效的integer。" % field),
            "max_value": gettext_lazy(
                "【%s】请确保此值小于或等于 {max_value} 。" % field
            ),
            "min_value": gettext_lazy(
                "【%s】请确保此值大于或等于 {min_value} 。" % field
            ),
    ...
    def list(field: str):
        return {
            "not_a_list": gettext_lazy(
                '【%s】应为列表,但得到的类型为 "{input_type}".' % field
            ),
            "empty": gettext_lazy("【%s】此列表不能为空。" % field),
            "min_length": gettext_lazy(
                "【%s】请确保此字段至少包含 {min_length} 个元素。" % field
            ),
            "max_length": gettext_lazy(
                "【%s】请确保此字段的元素不超过 {max_length} 个。" % field
            ),
            "required": gettext_lazy("【%s】此字段必填。" % field),
            "null": gettext_lazy("【%s】此字段不能为null。" % field),
        }
    ...
    def boolean(field: str):
        return {
            "invalid": gettext_lazy("【%s】必须是有效的布尔值。" % field),
            "required": gettext_lazy("【%s】此字段必填。" % field),
            "null": gettext_lazy("【%s】此字段不能为null。" % field),
        }
    ...
    def dict(field: str):
        return {
            "not_a_dict": gettext_lazy(
                '【%s】应为字典,但得到的类型为 "{input_type}' % field
            ),
    ...
    def float(field: str):
        return {
            "invalid": gettext_lazy("【%s】需要一个有效的数字。" % field),
            "max_value": gettext_lazy(
                "【%s】请确保此值小于或等于 {max_value}。" % field
            ),
            "min_value": gettext_lazy(
    ...
    def image(field: str):
        return {
            "required": gettext_lazy("【%s】此字段必填。" % field),
            "null": gettext_lazy("【%s】此字段不能为null。" % field),
            "invalid_image": gettext_lazy(
                "【%s】上载有效的图像。您上载的文件不是图像或图像已损坏。" % field
            ),
            "max_length": gettext_lazy(
                "请确保此文件名最多包含 {max_length} 个字符(长度为 {length})。"
            ),
        }
