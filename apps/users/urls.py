...
urlpatterns = [
    ...
    path(
        "user/current/send_email",
        views.SendEmailToCurrentUserView.as_view(),
        name="send_email_current",
    ),
    path(
    ...
    path(
        "user_manage/<str:user_id>",
        views.UserManage.Operate.as_view(),
        name="user_manage_operate",
    ),
    path(
        "user_manage/<str:user_id>/re_password",
        views.UserManage.RePassword.as_view(),
        name="user_manage_re_password",
    ),
    path(
        "user_manage/<int:current_page>/<int:page_size>",
        views.UserManage.Page.as_view(),
        name="user_manage_re_password",
    ),
]
