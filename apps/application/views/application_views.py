...
from application.serializers.application_statistics_serializers import (
...
class Application(APIView):
    ...
    class Model(APIView):
        ...
        def get(self, request: Request, application_id: str):
            return result.success(
                ...
                ).list_model(request.query_params.get("model_type"))
            )
    ...
    class ModelParamsForm(APIView):
        ...
        def get(self, request: Request, application_id: str, model_id: str):
            return result.success(
                ApplicationSerializer.Operate(
                    data={"application_id": application_id, "user_id": request.user.id}
                ).get_model_params_form(model_id)
            )
        ...
        class Operate(APIView):
            ...
            def get(self, request: Request, application_id: str, function_lib_id: str):
                return result.success(
                    ...
                    ).get_function_lib(function_lib_id)
                )
    ...
    class ApplicationKey(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary="获取应用API_KEY列表",
    ...
    class AccessToken(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary="修改 应用AccessToken",
        ...
        def put(self, request: Request, application_id: str):
            return result.success(
                ApplicationSerializer.AccessTokenSerializer(
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary="获取应用 AccessToken信息",
    ...
    @has_permissions(
        PermissionConstants.APPLICATION_CREATE, compare=CompareConstants.AND
    )
    def post(self, request: Request):
        return result.success(
            ApplicationSerializer.Create(data={"user_id": request.user.id}).insert(
                request.data
            )
        )
    ...
    class Operate(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary="修改应用",
            operation_id="修改应用",
            manual_parameters=ApplicationApi.Operate.get_request_params_api(),
            request_body=ApplicationApi.Edit.get_request_body_api(),
            responses=result.get_api_array_response(
                ApplicationApi.get_response_body_api()
            ),
            tags=["应用"],
        )
        @has_permissions(
    ...
    class ListApplicationDataSet(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary="获取当前应用可使用的知识库",
    ...
    class Page(APIView):
        ...
        @has_permissions(
            PermissionConstants.APPLICATION_READ, compare=CompareConstants.AND
        )
