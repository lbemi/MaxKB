...
from application.flow.step_node.search_dataset_node.i_search_dataset_node import (
    ISearchDatasetStepNode,
)
    ...
    def execute(
        ...
        **kwargs
        ...
        embedding_list = vector.query(
            ...
            True,
            dataset_setting.get("top_n"),
            dataset_setting.get("similarity"),
            SearchMode(dataset_setting.get("search_mode")),
        )
