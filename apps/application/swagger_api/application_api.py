    ...
    def get_response_body_api():
        return openapi.Schema(
            ...
            properties={
                ...
                "name": openapi.Schema(
                    type=openapi.TYPE_STRING, title="应用名称", description="应用名称"
                ),
                "desc": openapi.Schema(
                    type=openapi.TYPE_STRING, title="应用描述", description="应用描述"
                ),
                ...
                "user_id": openapi.Schema(
                    type=openapi.TYPE_STRING, title="所属用户", description="所属用户"
                ),
                "status": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN, title="是否发布", description="是否发布"
                ),
                "create_time": openapi.Schema(
                    type=openapi.TYPE_STRING, title="创建时间", description="创建时间"
                ),
                "update_time": openapi.Schema(
                    type=openapi.TYPE_STRING, title="修改时间", description="修改时间"
                ),
                "dataset_id_list": openapi.Schema(
                    type=openapi.TYPE_ARRAY,
                    items=openapi.Schema(type=openapi.TYPE_STRING),
                    title="关联知识库Id列表",
            ...
            def get_request_body_api():
                return openapi.Schema(
                    ...
                    properties={
                        ...
                        "allow_cross_domain": openapi.Schema(
                            type=openapi.TYPE_BOOLEAN,
                            title="是否允许跨域",
                            description="是否允许跨域",
                        ),
                        "cross_domain_list": openapi.Schema(
                            type=openapi.TYPE_ARRAY,
                            title="跨域列表",
                            items=openapi.Schema(type=openapi.TYPE_STRING),
                        ),
    ...
    class AccessToken(ApiMixin):
        ...
        def get_request_body_api():
            return openapi.Schema(
                ...
                required=[],
                properties={
                    "access_token_reset": openapi.Schema(
                        type=openapi.TYPE_BOOLEAN,
                        title="重置Token",
                        description="重置Token",
                    ),
                    ...
                    "access_num": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title="访问次数",
                        description="访问次数",
                    ),
                    "white_active": openapi.Schema(
                        type=openapi.TYPE_BOOLEAN,
                        title="是否开启白名单",
                        description="是否开启白名单",
                    ),
                    "white_list": openapi.Schema(
                        type=openapi.TYPE_ARRAY,
                        items=openapi.Schema(type=openapi.TYPE_STRING),
                        title="白名单列表",
                        description="白名单列表",
                    ),
                    "show_source": openapi.Schema(
                        type=openapi.TYPE_BOOLEAN,
                        title="是否显示知识来源",
        ...
        def get_request_body_api():
            return openapi.Schema(
                ...
                properties={
                    ...
                    "problem_optimization": openapi.Schema(
                        type=openapi.TYPE_BOOLEAN,
                        title="问题优化",
                        description="是否开启问题优化",
                        default=True,
                    ),
                    "icon": openapi.Schema(
                        type=openapi.TYPE_STRING,
        ...
        def get_request_body_api():
            return openapi.Schema(
                ...
                properties={
                    ...
                    "max_paragraph_char_number": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title="最多引用字符数",
                        description="最多引用字符数",
                        default=3000,
                    ),
                    "search_mode": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title="检索模式",
                        description="embedding|keywords|blend",
                        default="embedding",
                    ),
                    "no_references_setting": openapi.Schema(
                        type=openapi.TYPE_OBJECT,
                        title="检索模式",
