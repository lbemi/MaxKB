...
class ChatApi(ApiMixin):
        ...
        return openapi.Schema(
            ...
            properties={
                "message": openapi.Schema(
                    type=openapi.TYPE_STRING, title="问题", description="问题"
                ),
                "re_chat": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN, title="重新生成", default=False
                ),
                "stream": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN, title="重新生成", default=True
                ),
            },
        )
    ...
    def get_response_body_api():
        return openapi.Schema(
            ...
            properties={
                "id": openapi.Schema(
                    type=openapi.TYPE_STRING, title="id", description="id", default="xx"
                ),
                ...
                "chat_record_count": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title="对话提问数量",
                    description="对话提问数量",
                    default="对话提问数量",
                ),
                "mark_sum": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title="标记数量",
                    description="标记数量",
                    default=1,
    ...
    def get_response_body_api():
        return openapi.Schema(
            ...
            properties={
                ...
                "message_tokens": openapi.Schema(
                    type=openapi.TYPE_INTEGER,
                    title="问题消耗token数量",
                    description="问题消耗token数量",
                    default=0,
                ),
                "answer_tokens": openapi.Schema(
                    type=openapi.TYPE_INTEGER,
                    title="答案消耗token数量",
                    description="答案消耗token数量",
                    default=0,
                ),
                "improve_paragraph_id_list": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title="改进标注列表",
                    description="改进标注列表",
                    default=[],
        ...
        return openapi.Schema(
            ...
            properties={
                "title": openapi.Schema(
                    type=openapi.TYPE_STRING, title="段落标题", description="段落标题"
                ),
                "content": openapi.Schema(
                    type=openapi.TYPE_STRING, title="段落内容", description="段落内容"
                ),
            },
        )
