        ...
        def get_response_body_api():
            return openapi.Schema(
                ...
                properties={
                    ...
                    "customer_num": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title="客户数量",
                        description="客户数量",
                    ),
                    "customer_added_count": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title="客户新增数量",
                        description="客户新增数量",
                    ),
    ...
    class CustomerCountTrend(ApiMixin):
        ...
        def get_response_body_api():
            return openapi.Schema(
                ...
                properties={
                    "added_count": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title="新增数量",
                        description="新增数量",
                    ),
                    "day": openapi.Schema(
                        type=openapi.TYPE_STRING, title="时间", description="时间"
                    ),
                },
            )
    ...
    class CustomerCount(ApiMixin):
        ...
        def get_response_body_api():
            return openapi.Schema(
                ...
                required=["added_count"],
                properties={
                    "today_added_count": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title="今日新增数量",
                        description="今日新增数量",
                    ),
